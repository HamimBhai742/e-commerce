...
router.patch(
  ...
  adminController.manageOrder,
);
router.patch(
  "/manage-payment",
  checkAuth(Role.ADMIN),
  adminController.managePayment,
);
router.post(
  "/create-promo-code",
  checkAuth(Role.ADMIN),
  validateRequest(promoZodSchema),
...
router.get(
  "/all-used-promo-codes",
  checkAuth(Role.ADMIN),
  adminController.getAllUsedPromoCode,
);
router.put(
  "/update-promo-code/:promoId",
  checkAuth(Role.ADMIN),
  validateRequest(updatePromoZodSchema),
  adminController.updatePromoCode,
);
router.delete(
  "/delete-promo-code/:promoId",
  checkAuth(Role.ADMIN),
